<template>
  <div v-if="mixinState.mSelectMode === 'multiple'" class="attr-item-box">
    ...
    <div class="bg-item">
      ...
      <Tooltip :content="$t('alignCenterX')">
      ...
      <Tooltip :content="$t('alignCenterY')">
      ...
      <!-- 平均对齐 -->
      <Tooltip :content="$t('alignAverageX')">
      ...
      <Tooltip :content="$t('alignAverageY')">
