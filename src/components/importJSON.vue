...
<template>
  <div style="display: inline-block">
    <Dropdown @on-click="clickHandler">
      ...
      <template #list>
        <DropdownMenu>
          ...
          <DropdownItem name="importFiles">{{ $t('importFiles') }}</DropdownItem>
    ...
    <!-- 创建设计 -->
    <modalSzie :title="$t('title')" ref="modalSizeRef" @set="customSizeCreate"></modalSzie>
  </div>
</template>
